...
<h2 align="center">Agregar la categoria que corresponda</h2>
<hr />
                                        <h3 class="text-center font-weight-light my-4">Ingrese la Categoria correspondiente</h3></div>
                                    <div class="card-body">
<form method="post" name="signup" onsubmit="return checkpass();">

<!--<div class="row mb-3">-->
<label for="inputFirstName">Ingresar la categoria:</label>
<div class="col-md-11">
