...
/*CREATE TABLE `preguntas-respuestas-chatbot` (
  `id_preg_resp` int(11) NOT NULL AUTO_INCREMENT,
  `preguntas` varchar(9000) DEFAULT NULL,
  `respuestas` varchar(9000) DEFAULT NULL,
  
  PRIMARY KEY (`id_preg_resp`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=latin1;

CREATE TABLE `categoria` (
  `id_categoria` int(11) NOT NULL AUTO_INCREMENT,
  `nombre_categoria` varchar(9000) DEFAULT NULL,
...
CREATE TABLE `subcategoria` (
  ...
  `nombre_subcategoria` varchar(9000) DEFAULT NULL,
